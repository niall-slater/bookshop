...
var verbs_present = ["kill", "brexit", "kiss", "arraign", "march", "serve", "hit", "shake", "walk", "escort", "fight", "sort out", "ruin", "destroy", "repair", "give birth to", "celebrate", "commemorate", "remember", "forget", "drive", "smoke", "regret", "seduce", "frighten", "cuddle", "follow", "wank off", "wank over", "marry", "murder", "annex", "backpack"];
var verbs_present_er = ["kill", "brexit", "kiss", "arraign", "march", "serv", "spank", "shak", "walk", "escort", "fight", "ruin", "destroy", "fix", "truth", "stalk", "hold", "record", "forgett", "driv", "smok", "regrett", "seduc", "frighten", "cuddl", "follow", "wank", "murder"];
